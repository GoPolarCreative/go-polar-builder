...
/**
 * The test business used by the seed script and by any probe that needs a realistic intake.
 *
 * Invented for testing. Not a real Go Polar customer. It lives in its own file so a script can
 * borrow it without also running the seed.
 */
export const INTAKE: IntakePayload = {
